...
const carreraSchema = Joi.object({
    ...
    grado: Joi.string().max(50).required().valid("Titulo intermedio", "Licenciatura").messages({
        "string.max": "El nombre de grado debe contener como máximo {#limit}",
        "any.required": "El nombre de grado es requerido",
        "any.only": "Los nombres de grado solo pueden ser: Titulo Intermedio, Licenciatura"
    }),
