...
const { validateCarreraName, validateMaterias } = require('../middlewares/validador.schema')
...
router.post('/carreras',  validateCarreraName, validateMaterias, carrerasController.createCarrera)
